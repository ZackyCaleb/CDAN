...
parser.add_argument('--image_size', type=int, default=128, help='Number of epochs to train (default: 50)')
...
parser.add_argument('--pkl_dir', type=str, default=r'./affectnwt.pkl')
