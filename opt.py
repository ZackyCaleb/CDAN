...
parser.add_argument('--images_dir', type=str, default=r'./datasets/imgs', help='Path to traindata')
...
parser.add_argument('--pkl_dir', type=str, default=r'./datasets/pkl/affect_HaSa_au.pkl')
parser.add_argument('--lpips_check', type=str, default=r'Path for lpips_check')
